...
void voltar_pos_inicial_peca1_fase1(q1 matriz[], int p) {
	...
	if (p == 0) {
		matriz[0].pos_x_inicial = 600;
		matriz[0].pos_y_inicial = 400;
		matriz[0].pos_x_final = 640;
		matriz[0].pos_y_final = 440;
		matriz[1].pos_x_inicial = 640;
		matriz[1].pos_y_inicial = 440;
		matriz[1].pos_x_final = 680;
		matriz[1].pos_y_final = 480;
		matriz[2].pos_x_inicial = 600;
		matriz[2].pos_y_inicial = 440;
		matriz[2].pos_x_final = 640;
		matriz[2].pos_y_final = 480;
		matriz[3].pos_x_inicial = 600;
		matriz[3].pos_y_inicial = 480;
		matriz[3].pos_x_final = 640;
		matriz[3].pos_y_final = 520;
	}
	else {
		...
		matriz[0].pos_x_final = 640;
		matriz[0].pos_y_final = 440;
		matriz[1].pos_x_inicial = 560;
		matriz[1].pos_y_inicial = 440;
		matriz[1].pos_x_final = 600;
		matriz[1].pos_y_final = 480;
		matriz[2].pos_x_inicial = 600;
		matriz[2].pos_y_inicial = 440;
		matriz[2].pos_x_final = 640;
...
void voltar_pos_inicial_peca2_fase1(q1 matriz1[], int q) {
	...
	if (q == 0) {
		...
		matriz1[2].pos_y_inicial = 400;
		matriz1[2].pos_x_final = 720;
		matriz1[2].pos_y_final = 440;
...
int verificar_se_posicao_ok_fase1_peca1(q1 matriz1[]) {
	if (matriz1[0].pos_x_inicial >= 140 - xy_fase1 && matriz1[0].pos_y_inicial >= 180 - xy_fase1 && matriz1[0].pos_x_final <= 180 + xy_fase1 && matriz1[0].pos_y_final <= 220 + xy_fase1
		&& matriz1[1].pos_x_inicial >= 180 - xy_fase1 && matriz1[1].pos_y_inicial >= 220 - xy_fase1 && matriz1[1].pos_x_final <= 220 + xy_fase1 && matriz1[1].pos_y_final <= 260 + xy_fase1
		&& matriz1[2].pos_x_inicial >= 140 - xy_fase1 && matriz1[2].pos_y_inicial >= 220 - xy_fase1 && matriz1[2].pos_x_final <= 180 + xy_fase1 && matriz1[2].pos_y_final <= 260 + xy_fase1
		&& matriz1[3].pos_x_inicial >= 140 - xy_fase1 && matriz1[3].pos_y_inicial >= 260 - xy_fase1 && matriz1[3].pos_x_final <= 180 + xy_fase1 && matriz1[3].pos_y_final <= 300 + xy_fase1) {
		return 1;
	}
	else {
		return -1;
...
int verificar_se_posicao_ok_fase1_peca2(q1 matriz1[]) {
	if (matriz1[0].pos_x_inicial >= 220 - xy_fase1 && matriz1[0].pos_y_inicial >= 180 - xy_fase1 && matriz1[0].pos_x_final <= 260 + xy_fase1 && matriz1[0].pos_y_final <= 220 + xy_fase1
		&& matriz1[1].pos_x_inicial >= 220 - xy_fase1 && matriz1[1].pos_y_inicial >= 220 - xy_fase1 && matriz1[1].pos_x_final <= 260 + xy_fase1 && matriz1[1].pos_y_final <= 260 + xy_fase1
		&& matriz1[2].pos_x_inicial >= 220 - xy_fase1 && matriz1[2].pos_y_inicial >= 260 - xy_fase1 && matriz1[2].pos_x_final <= 260 + xy_fase1 && matriz1[2].pos_y_final <= 300 + xy_fase1) {
		return 2;
	}
	else {
		return -2;
...
void posicoes_fase1_peca1(POSICOES pos[]) {
	...
	pos[1].matriz1[1].pos_x_inicial = 560;
	pos[1].matriz1[1].pos_y_inicial = 440;
	pos[1].matriz1[1].pos_x_final = 600;
	...
	pos[1].matriz1[2].pos_y_inicial = 440;
	pos[1].matriz1[2].pos_x_final = 640;
	pos[1].matriz1[2].pos_y_final = 480;
	pos[1].matriz1[2].quadrado = load_bitmap("quadradoMatriz1.bmp", NULL);
	pos[1].matriz1[3].pos_x_inicial = 600;
	pos[1].matriz1[3].pos_y_inicial = 480;
	pos[1].matriz1[3].pos_x_final = 640;
...
void posicoes_fase1_peca2(POSICOES pos[]) {
	...
	pos[1].matriz1[2].pos_y_inicial = 400;
	pos[1].matriz1[2].pos_x_final = 720;
	pos[1].matriz1[2].pos_y_final = 440;
	pos[1].matriz1[2].quadrado = load_bitmap("quadradoMatriz1.bmp", NULL);
...
void funcao_tela_fase_1(int *screen_state, int *fase) {
	...
	posicoes_fase1_peca1(pos);
	posicoes_fase1_peca2(pos1);

	while (*screen_state == TELA_FASE_1) {
		if (ok == -1 || ok == 0) {
			if (enter == 0) {
				while (!key[KEY_ENTER]) {
					for (i = 1; i <= 5; i++) {
						for (j = 1; j <= 5; j++) {
							if ((i == 1 && j == 2) || (i == 2 && j == 3) || (i == 1 && j == 3) || (i == 1 && j == 4)) {
			...
			if (mouse_b == 2) {
				click = 0;
				ok = verificar_se_posicao_ok_fase1_peca1(pos[p].matriz1);
				if (ok == 1) {
					...
					enter = 0;
					voltar_pos_inicial_peca1_fase1(pos[p].matriz1, p);
			...
			if (click == 1) {
				if (p == 0) {
					...
					pos[p].matriz1[3].pos_x_inicial = mouse_x;
					pos[p].matriz1[3].pos_y_inicial = mouse_y + 80;
					pos[p].matriz1[3].pos_x_final = pos[p].matriz1[0].pos_x_inicial + 40;
					pos[p].matriz1[3].pos_y_final = pos[p].matriz1[0].pos_y_inicial + 40;
				}
				else {
					pos[p].matriz1[0].pos_x_inicial = mouse_x;
					pos[p].matriz1[0].pos_y_inicial = mouse_y;
			...
			if (enter1 == 0) {
				while (!key[KEY_ENTER]) {
					...
					if (primeira_vez_peca2 == 0) {
						...
						draw_sprite(buffer, pos1[0].matriz1[2].quadrado, pos1[0].matriz1[2].pos_x_inicial, pos1[0].matriz1[2].pos_y_inicial);
						draw_sprite(screen, buffer, 0, 0);
						clear(buffer);
					}
					if (key[KEY_RIGHT]) {
					...
					if (key[KEY_LEFT]) {
						...
						draw_sprite(buffer, pos1[1].matriz1[2].quadrado, pos1[1].matriz1[2].pos_x_inicial, pos1[1].matriz1[2].pos_y_inicial);
						q = 1;
						draw_sprite(screen, buffer, 0, 0);
						clear(buffer);
					}
			...
			if (mouse_b == 2) {
				click1 = 0;
				ok = verificar_se_posicao_ok_fase1_peca2(pos1[q].matriz1);
				if (ok == 2) {
					play_sample(respostaCerta, 255, 128, 1000, FALSE);
					if (xy_fase1 > 0) {
						xy_fase1--;
					...
					*fase = TELA_FASE_2;
					...
					play_sample(respostaErrada, 255, 128, 1000, FALSE);
					enter1 = 0;
					voltar_pos_inicial_peca2_fase1(pos1[q].matriz1, q);
			...
			if (click1 == 1) {
				if (q == 0) {
					...
					pos1[q].matriz1[2].pos_x_inicial = mouse_x;
					pos1[q].matriz1[2].pos_y_inicial = mouse_y + 80;
					pos1[q].matriz1[2].pos_x_final = pos1[q].matriz1[2].pos_x_inicial + 40;
					pos1[q].matriz1[2].pos_y_final = pos1[q].matriz1[2].pos_y_inicial + 40;
					...
					pos1[q].matriz1[2].pos_x_inicial = mouse_x + 80;
					pos1[q].matriz1[2].pos_y_inicial = mouse_y;
					pos1[q].matriz1[2].pos_x_final = pos1[q].matriz1[2].pos_x_inicial + 40;
					pos1[q].matriz1[2].pos_y_final = pos1[q].matriz1[2].pos_y_inicial + 40;
			...
			if (q == 0) {
				...
				draw_sprite(buffer, pos1[q].matriz1[2].quadrado, pos1[q].matriz1[2].pos_x_inicial, pos1[q].matriz1[2].pos_y_inicial);
			}
			if (q == 1) {
				draw_sprite(buffer, pos1[q].matriz1[0].quadrado, pos1[q].matriz1[0].pos_x_inicial, pos1[q].matriz1[0].pos_y_inicial);
				draw_sprite(buffer, pos1[q].matriz1[1].quadrado, pos1[q].matriz1[1].pos_x_inicial, pos1[q].matriz1[1].pos_y_inicial);
